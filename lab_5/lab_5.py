...
class BokehProgram:
    def __init__(self):
        ...
        # *************************
        # Imagine that we got some some strange radio signal form space
        # and we are trying to analyze it
        # *************************
        ...
        # plot object
        self.plot = None
        # bokeh data type object, there will be both axises
        self.source = None
